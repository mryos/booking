...
const INITIAL_ROOMS = [
  ...
  { id: 'studio', name: 'Ruang Studio Office', shortName: 'Studio Office', floor: 'Lantai 1', description: 'Ruang studio multifungsi untuk recording, workshop, dan kegiatan kreatif.', facilities: ['Alat Musik Lengkap', 'Recording', 'AC', 'Wi-Fi', 'Lighting'], color: '#f19015' },
];
